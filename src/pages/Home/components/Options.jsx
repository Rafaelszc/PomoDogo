        ...
        return (
            <div className="fixed">
                ...
                <div className={`${popUpAnimation} flex flex-col gap-8 z-30 fixed w-1/2 h-5/6 rounded-xl bg-${theme === "dark" ? "black" : "white"} border-gray-500 border overflow-scroll animate-arise`} style={{top: "50%", left: "50%", transform: "translate(-50%, -50%)"}}>
                    ...
                    <li className="flex items-center justify-center flex-col w-full gap-5">
                        <ul className={`list-none w-5/6 h-28 rounded-xl flex justify-between items-center ${theme === "dark" ? "bg-gray-900 text-white" : "bg-white text-black"} border border-gray-500 pl-10 pr-10`}>
